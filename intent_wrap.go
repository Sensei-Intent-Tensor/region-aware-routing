...
# Obstacle: false is used directly — with a comment. If Tesla wants to integrate sensor feeds later, they can modify this line only.
# deriveUrgency() uses current speed as a proxy — this is the best default logic available without more telemetry input.
